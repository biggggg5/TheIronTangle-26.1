...
import static net.minecraft.data.AtlasIds.BLOCKS;
import static net.minecraft.data.AtlasIds.ITEMS;

// The value here should match an entry in the META-INF/neoforge.mods.toml file
@Mod(TheIronTangleMod.MOD_ID)
public class TheIronTangleMod {
    // Define mod id in a common place for everything to reference
    public static final String MOD_ID = "theirontanglemod";
